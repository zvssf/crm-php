...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 11 2025 г., 00:58
...
--
-- Дамп данных таблицы `client_relatives`
--
...
(126, '2025-11-10 07:14:02', 1, '111.00', 1, 33, NULL, '', NULL);
...
CREATE TABLE `users` (
  ...
  `user_tel` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `user_tel_2` varchar(50) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
(1, 'a@a.a', 'e10adc3949ba59abbe56e057f20f883e', 1, 1, 'guPqSqXHcxEf80LKTMVHwMK96J8yPV6F1WJZnxQ3u+ioQm5QD2hD21auHSC5MTg0kIQepVgnNNFcnaW834hdNWUaCLnqsHAAf3HyEW9oAdn5j/t84Gr2ow73UBBCxwJY', 'Сергей', 'Фамилия', '+79009009090', NULL, '0.00', '0.00', 0, 0, NULL, NULL, NULL, NULL),
...
(33, 'agA@a.a', '202cb962ac59075b964b07152d234b70', 4, 1, '', 'Агент', 'тип-А-1', '+3234546657', NULL, '160.00', '1500.00', 32, 1, '', '', '', ''),
