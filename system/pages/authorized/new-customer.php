                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                    <div class="card-body">
                                                ...
                                                <form onsubmit="sendNewCustomerForm('#form-new-customer button[type=submit]')" id="form-new-customer" class="needs-validation" novalidate>
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Персональная информация</h5>
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="firstname" placeholder="Введите имя" name="user-firstname" maxlength="25" data-toggle="maxlength" required>
                                                                <div class="invalid-feedback">Введите имя!</div>
                                                            </div>

                                                            <div class="mb-3">
                                                                <label for="lastname" class="form-label">Фамилия</label>
                                                                <input type="text" class="form-control" id="lastname" placeholder="Введите фамилию" name="user-lastname" maxlength="25" data-toggle="maxlength" required>
                                                                <div class="invalid-feedback">Введите фамилию!</div>
                                                            </div>

                                                            <div class="mb-3">
                                                                <label for="useremail" class="form-label">Email</label>
                                                                <input type="text" class="form-control" id="useremail" placeholder="Введите email" name="user-login" maxlength="32" data-toggle="maxlength" required>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="select-supervisor" class="form-control select2" data-toggle="select2" name="select-supervisor">
                                                                        ...
                                                                        <?php foreach($supervisors as $supervisor): ?>
                                                                            <option value="<?= $supervisor['user_id'] ?>"><?= $supervisor['user_firstname'] ?> <?= $supervisor['user_lastname'] ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="select-manager" class="form-control select2" data-toggle="select2" name="select-manager">
                                                                        ...
                                                                        <?php foreach($managers as $manager): ?>
                                                                            <option value="<?= $manager['user_id'] ?>"><?= $manager['user_firstname'] ?> <?= $manager['user_lastname'] ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                </div>
